<?php
    ...
    include("usuario_cadastro_data.php");
?>
<div class="conteudo">
  <?php echo form_open('usuario/cadastrar', $data_form); ?>
  ...
  <div class="fundoModal" id="fundoModal">
    ...
    <div class="modal" id="modalSairSemSalvar">
      ...
      <div class="botoesModal">
        <a href="<?php echo site_url("sistema");?>"><input type="button" class="botao" value="Sim"/></a>
    ...
    <div class="modal" id="modalSucesso">
      ...
      <div class="botoesModal">
        <a href="<?php echo site_url("cadastroUsuario");?>"><input class="botao" value="Concluir"/></a>
      </div>
    </div>
...
$(document).ready(function() {
    ...
    $("#formUsuario").on('submit', function(event) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?php echo site_url("cadastrarUsuario"); ?>",
            dataType: 'json',
            data:
            {
              Us_CPF:    $("#cpf").val(),
