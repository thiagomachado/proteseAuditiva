      ...
      <table>
        ...
        <tr>
          <td colspan="4">
            ...
            <?php echo form_dropdown('profissional', $dataProfissional, $cpfProfissional, 'id = "profissional"'); ?>
          </td>
        </tr>
      </table>
    </fieldset>
    ...
    <fieldset class="secaoFormulario">
      ...
      <table>
        <tr>
          ...
          <td><?php echo form_dropdown('candidatoAASI',$dataOpcoesDropdown,$caracterizacao->Caract_AASI ,'id ="candidatoAASI"'); ?></td>
          <td>Possível candidato ao uso de implante coclear:</td>
          <td><?php echo form_dropdown('candidatoImplante', $dataOpcoesDropdown,$caracterizacao->Caract_ImplCoclear ,'id="candidatoImplante"'); ?></td>
        </tr>
      </table>
    </fieldset>
