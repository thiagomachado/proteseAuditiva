<?php
    ...
    include("procedimento_cadastro_data.php");
?>
<div class="conteudo">
    ...
    <fieldset class="secaoFormulario">
      ...
      <table>
        <tr>
          ...
          <td>
            <label>Tipo:</label><br>
            <?php echo form_dropdown('tipoProcedimento', $tipos,'1', 'id="tipoProcedimento" required'); ?>
          </td>
        </tr>
      </table>
    </fieldset>
  ...
  <div class="fundoModal" id="fundoModal">
    ...
    <div class="modal" id="modalSairSemSalvar">
      ...
      <div class="botoesModal">
        <a href="<?php echo site_url('procedimento');?>"><input type="button" class="botao" value="Sim"/></a>
    ...
    <div class="modal" id="modalSucesso">
      <div class="textoModal">
        <h1>Sucesso!</h1>
        <p>O procedimento foi cadastrado.</p>
      </div>
...
$(document).ready(function() {
    $("#formProcedimento").on('submit', function(event) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/cadastrarProcedimento",
            dataType: 'json',
            data:
            {
