<?php
    ...
    include("anamneseInfantil_edicao_data.php");
?>
         ...
         <table>
           <tr>
             ...
             <td>
               ...
               <?php echo form_dropdown('tipoParto', $dataTipoParto,$anamnese->AnmInf_Parto, 'id="tipoParto" required'); ?>
             </td>
           </tr>
         </table>
       </fieldset>
...
$(document).ready(function() {
    $("#formAnamneseInfantil").on('submit', function(event) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/editarAnamneseInfantil",
            dataType: 'json',
            data:
            {
              cpf:                         $("#cpfHidden").val(),
