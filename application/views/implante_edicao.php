<?php
    ...
    include("implante_edicao_data.php");
?>
<div class="conteudo">
  <?php
      ...
      <table>
        ...
        <tr>
          <td>
              ...
              <?php echo form_dropdown('classe', $dataClasse,$implante->classe_id, 'id="classe" required'); ?>
          </td>
          <td>
...
$(document).ready(function() {
    $("#formImplante").on('submit', function(event) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/editarImplante",
            dataType: 'json',
            data:
            {
              Impl_Id:       $("#id").val(),
